  ...
  return (
    <div className="bg-navy relative w-full h-lvh  justify-center items-center content-center inset-0 md:px-40 p-20 flex flex-col">
      ...
      <div className="flex flex-col justify-center content-center items-center">
            ...
            <h1 className="text-lightslategray text-lg font-sans mt-3 text-center w-1/2">I am always looking for new opportunities, my inbox is always open. Whether you have a question or just want to say Hi, I will try mu best to get back to you!</h1>
